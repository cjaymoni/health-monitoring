...
const SidebarHeader = () => {
  ...
  return (
    <div className={classes.root}>
      <CmtAvatar src={'https://media-exp1.licdn.com/dms/image/C4E03AQEvqNjzEsWb6g/profile-displayphoto-shrink_800_800/0/1599364928604?e=1655942400&v=beta&t=7s_QBE3D-tTl54mh0tR5zces1ckFkAxx3gvVihULLMM'}/>
      <div className={classes.userInfo} onClick={handlePopoverOpen}>
        <div
          ...
          <div className="mr-2">
            ...
            <Typography className={classes.userSubTitle}>Receptionist</Typography>
          </div>
          <ArrowDropDownIcon />
        </div>
      </div>
