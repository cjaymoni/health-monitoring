export const crm = {
  ...
  ticketsStatus: [
    { name: 'Honoured', value: 40, color: '#45C3E5' },
    { name: 'Confirmed', value: 8, color: '#E0E0E0' },
    { name: 'Cancelled', value: 15, color: '#E16618' },
    { name: 'Rescheduled', value: 18, color: '#57BE4A' },
    { name: 'Booked', value: 28, color: '#FFC0CB' },
    { name: 'Pending', value: 11, color: '#FFFF00' },
  ],
  revenueHistory: [
